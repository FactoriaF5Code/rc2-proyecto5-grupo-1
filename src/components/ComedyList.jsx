...
export const ComedyList = ({ currentLanguage }) => {
    ...
    useEffect(() => {
        ...
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=35&language=${currentLanguage}`;
    ...
    return (
        <>
            ...
            <div className="listTitle">
                ...
                <h2 className="listTitleH2">{translatedTexts.comedia}</h2>

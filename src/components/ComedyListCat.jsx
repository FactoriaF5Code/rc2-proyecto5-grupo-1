...
export const ComedyListCat = () => {
    const [comedyMovies, setComedyMovies] = useState([]);

    useEffect(() => {
        const apiKey = "ca058e3f495796073a20627d0140ccc3";
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=35&language=cat-CAT`;
    ...
    return (
        <>
            ...
            <div className="listTitle">
                ...
                <h2 className="listTitleH2">La relliscada amb què et descollonaràs!</h2>

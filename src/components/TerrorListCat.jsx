...
export const TerrorListCat = () => {
    const [terrorMovies, setTerrorMovies] = useState([]);

    useEffect(() => {
        const apiKey = "ca058e3f495796073a20627d0140ccc3";
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=27&language=cat-CAT`;
        ...
        <>
            <main className="galleryMovies">
                <div className="listTitle">
                    ...
                    <h2 className="listTitleH2">Aquesta nit vigila bé les finestres</h2>

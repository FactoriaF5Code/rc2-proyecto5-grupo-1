...
export const ThrillerList = ({ currentLanguage }) => {
    ...
    useEffect(() => {
        ...
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=53&language=${currentLanguage}`;
        ...
        <>
            <main className="galleryMovies">
                <div className="listTitle">
                    <img className="iconTitle" src="public/imgs/thriller.svg" alt="icono Thriller" />
                    <h2 className="listTitleH2">{translatedTexts.thriller}</h2>

...
export const ThrillerListCat = () => {
    const [thrillerMovies, setThrillerMovies] = useState([]);

    useEffect(() => {
        const apiKey = "ca058e3f495796073a20627d0140ccc3";
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=53&language=cat-CAT`;
        ...
        <>
            <main className="galleryMovies">
                <div className="listTitle">
                    ...
                    <h2 className="listTitleH2">Thrillers que et posaran els pèls de punta</h2>
